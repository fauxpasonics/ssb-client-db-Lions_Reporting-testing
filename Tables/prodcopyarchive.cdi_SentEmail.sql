CREATE TABLE [prodcopyarchive].[cdi_SentEmail]
(
...
GO
ALTER TABLE [prodcopyarchive].[cdi_SentEmail] ADD CONSTRAINT [PK__cdi_Sent__1311180BD25E4417] PRIMARY KEY CLUSTERED  ([cdi_sentemailid])
GO
