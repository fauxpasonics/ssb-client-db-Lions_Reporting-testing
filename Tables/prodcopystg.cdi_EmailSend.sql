CREATE TABLE [prodcopystg].[cdi_EmailSend]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_Email__copyl__1A9EF37A] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[cdi_EmailSend] ADD CONSTRAINT [PK__cdi_Emai__F120196B63705161] PRIMARY KEY CLUSTERED  ([cdi_emailsendid])
GO
