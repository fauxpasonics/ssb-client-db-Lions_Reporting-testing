CREATE TABLE [prodcopy].[PhoneCall]
(
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__PhoneCall__copyl__59063A47] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[PhoneCall] ADD CONSTRAINT [PK__PhoneCal__0FC8C7C4DD4FD07B] PRIMARY KEY CLUSTERED  ([activityid])
GO
