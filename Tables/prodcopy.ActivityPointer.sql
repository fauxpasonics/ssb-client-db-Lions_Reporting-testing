...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__ActivityP__copyl__2B3F6F97] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[ActivityPointer] ADD CONSTRAINT [PK__Activity__0FC8C7C44BC0966A] PRIMARY KEY CLUSTERED  ([activityid])
GO
