CREATE TABLE [prodcopystg].[str_ticketcase]
(
...
GO
ALTER TABLE [prodcopystg].[str_ticketcase] ADD CONSTRAINT [PK__str_tick__0D165682B91276FB] PRIMARY KEY CLUSTERED  ([str_ticketcaseid])
GO
