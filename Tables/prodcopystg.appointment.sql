CREATE TABLE [prodcopystg].[appointment]
(
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_appointment] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[appointment] ADD CONSTRAINT [PK__appointm__0FC8C7C4687733E9] PRIMARY KEY CLUSTERED  ([activityid])
GO
