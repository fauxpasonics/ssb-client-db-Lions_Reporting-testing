CREATE TABLE [prodcopystg].[cdi_EmailEvent]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_Email__copyl__22401542] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[cdi_EmailEvent] ADD CONSTRAINT [PK__cdi_Emai__43A077C58D07378F] PRIMARY KEY CLUSTERED  ([cdi_emaileventid])
GO
