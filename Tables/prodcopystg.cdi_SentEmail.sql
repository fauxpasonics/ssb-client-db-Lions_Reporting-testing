CREATE TABLE [prodcopystg].[cdi_SentEmail]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_SentE__copyl__2057CCD0] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[cdi_SentEmail] ADD CONSTRAINT [PK__cdi_Sent__1311180BD22D5BC9] PRIMARY KEY CLUSTERED  ([cdi_sentemailid])
GO
