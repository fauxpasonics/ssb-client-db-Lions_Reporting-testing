CREATE TABLE [prodcopystg].[email]
(
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_email] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[email] ADD CONSTRAINT [PK__email__0FC8C7C40AFD620E] PRIMARY KEY CLUSTERED  ([activityid])
GO
