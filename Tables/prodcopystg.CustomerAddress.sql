...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_CustomerAddress] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[CustomerAddress] ADD CONSTRAINT [PK__Customer__B4F00315231D8515] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO
