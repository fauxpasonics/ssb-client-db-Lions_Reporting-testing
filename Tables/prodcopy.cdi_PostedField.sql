CREATE TABLE [prodcopy].[cdi_PostedField]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_Poste__copyl__36470DEF] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[cdi_PostedField] ADD CONSTRAINT [PK__cdi_Post__345A2DDCF3443005] PRIMARY KEY CLUSTERED  ([cdi_postedfieldid])
GO
