CREATE TABLE [prodcopystg].[SystemUser]
(
[accessmode] [int] NULL,
...
[applicationiduri] [nvarchar] (1024) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_SystemUser] DEFAULT (getdate()),
[new_VeritixUserID] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [prodcopystg].[SystemUser] ADD CONSTRAINT [PK__SystemUs__E4276C1FEEE66C97] PRIMARY KEY CLUSTERED  ([systemuserid])
GO
