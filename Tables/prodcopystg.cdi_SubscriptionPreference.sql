CREATE TABLE [prodcopystg].[cdi_SubscriptionPreference]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_Subsc__copyl__3A179ED3] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[cdi_SubscriptionPreference] ADD CONSTRAINT [PK__cdi_Subs__2ABC775E8F9EA590] PRIMARY KEY CLUSTERED  ([cdi_subscriptionpreferenceid])
GO
