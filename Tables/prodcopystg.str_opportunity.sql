...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF_ProdCopy_str_opportunity] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[str_opportunity] ADD CONSTRAINT [PK__str_oppo__0ACAF85A1CEF38A5] PRIMARY KEY CLUSTERED  ([str_opportunityid])
GO
