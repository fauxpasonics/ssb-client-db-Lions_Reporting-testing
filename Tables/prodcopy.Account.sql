...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__Account__copyloa__1367E606] DEFAULT (getdate()),
...
GO
ALTER TABLE [prodcopy].[Account] ADD CONSTRAINT [PK__Account__F20699F6C20726B2] PRIMARY KEY CLUSTERED  ([accountid])
GO
