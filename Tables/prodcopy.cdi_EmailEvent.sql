CREATE TABLE [prodcopy].[cdi_EmailEvent]
(
...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__cdi_Email__copyl__24285DB4] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[cdi_EmailEvent] ADD CONSTRAINT [PK__cdi_Emai__43A077C5A98D2130] PRIMARY KEY CLUSTERED  ([cdi_emaileventid])
GO
