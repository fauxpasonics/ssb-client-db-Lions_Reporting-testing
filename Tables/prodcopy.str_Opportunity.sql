CREATE TABLE [prodcopy].[str_Opportunity]
(
...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__str_Oppor__copyl__5EBF139D] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[str_Opportunity] ADD CONSTRAINT [PK__str_Oppo__0ACAF85AE645305F] PRIMARY KEY CLUSTERED  ([str_opportunityid])
GO
