...
[copyloaddate] [datetime] NOT NULL CONSTRAINT [DF__CustomerA__copyl__3C69FB99] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopy].[CustomerAddress] ADD CONSTRAINT [PK__Customer__B4F00315A934BFD2] PRIMARY KEY CLUSTERED  ([customeraddressid])
GO
